...
mixin _$Category {
  ...
  @override
  String toString() {
    return 'Category(id: $id, name: $name, sortOrder: $sortOrder, isActive: $isActive)';
  }
}
...
abstract mixin class $CategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, int sortOrder, bool isActive});
}
...
extension CategoryPatterns on Category {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, int sortOrder, bool isActive)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Category() when $default != null:
        return $default(_that.id, _that.name, _that.sortOrder, _that.isActive);
      case _:
        return orElse();
    }
  }
