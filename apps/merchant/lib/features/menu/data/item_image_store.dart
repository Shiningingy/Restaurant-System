...
/// Copies picked images into a stable app-owned folder and cleans them up on
/// removal. The DB stores only the resulting path + a label.
class ItemImageStore {
  ...
  /// Copies [sourcePath] into the app folder under a fresh name and returns
