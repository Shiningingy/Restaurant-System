...
YeeSushiMenu yeeSushiMenu() {
  ...
  final items = <domain.MenuItem>[
    ...
    item(
      ...
      second: '迷你蔬菜卷',
      desc: 'Sushi rice with a choice of cucumber or avocado.',
      cents: 849,
    ),
    ...
    item(
      ...
      second: '素食套餐',
      desc: 'Sushi rice, avocado, carrot, cucumber and sesame seeds.',
      cents: 1599,
    ),
    item(
      combos,
    ...
    item(
      ...
      second: '三文鱼套餐',
      desc: 'Sushi rice, fresh salmon, avocado and sesame seeds.',
      cents: 1699,
    ),
    item(
      combos,
    ...
    item(
      ...
      second: '至尊三文鱼套餐',
      desc: 'Sushi rice, fresh salmon, avocado, sesame seeds and spicy mayo.',
      cents: 1999,
    ),
