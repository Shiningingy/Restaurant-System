...
/// The in-app help (offline). Reached from the first-run welcome dialog and
/// from the home screen's Help action.
class HelpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sections = customerHelp(zh: zh);
    return Scaffold(
...
/// Renders one content line: `- ` → bullet, else paragraph.
...
/// Shows the one-time welcome dialog on first launch, then records that it has
/// been seen so it never shows again. Wrap the home with this; [child] is shown
/// unchanged.
